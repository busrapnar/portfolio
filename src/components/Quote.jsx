...
const Quote = () => {
  return (
    <div className="relative w-[712px] h-[95px] border border-[#ABB2BF] ">
      <div className="flex justify-center pt-1 absolute -top-3 left-4 w-[42px] h-[29px]  bg-[#282C33]">
        <svg
      ...
      <div className="flex justify-center items-center my-8 ">
        <p className="text-2xl font-medium ">
          With great power comer great electricity bill
        </p>
      </div>
      <div className="relative">
      <div className="flex justify-center pt-1 absolute -bottom-2 right-4 w-[42px] h-[29px]  bg-[#282C33]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="21"
