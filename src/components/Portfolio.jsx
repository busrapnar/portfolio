...
<div className='absolute top-[84px] -left-3 z-50'>
...
<div className='relative w-[457px] h-[386px]'>
    <Image src={"/Image.png"} alt='' layout='fill' className='z-50'></Image>
</div>
...
<div className='flex items-center border border-[#ABB2BF] w-[402px] h-8 ml-4 pl-5 gap-2'>
